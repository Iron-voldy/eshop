                            ...
                            <div class="col-12 col-lg-9">
                                <div class="row">
                                    ...
                                    for ($x = 0; $x < $cart_num; $x++) {
                                        ...
                                        $seller_rs = Database::search("SELECT * FROM `users` WHERE `email`='" . $product_data["user_email"] . "'");
                                            ...
                                            <div class="row g-0">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="<?php echo $product_data["description"]; ?>" title="Product Description">
                                                        ...
                                                        ?>
                                                        <img src="<?php echo ($product_img_data["code"]); ?>" class="img-fluid rounded-start" style="max-width: 200px;">
                                                    </span>
                                                ...
                                                <div class="col-md-5">
                                                    <div class="card-body">
                                                        ...
                                                        <span class="fw-bold text-black-50">Colour : <?php
                                                                                                        $colour_rs = Database::search("SELECT * FROM `colour` WHERE id IN (SELECT color_id FROM product WHERE id ='" . $product_data["id"] . "')");
                                                                                                        $colour_data = $colour_rs->fetch_assoc();
                                                                                                        echo ($colour_data["name"]);
                                                                                                        ?></span> &nbsp; |

                                                        &nbsp; <span class="fw-bold text-black-50">Condition : <?php
                                                                                                                $condition_rs = Database::search("SELECT * FROM `condition` WHERE id IN (SELECT `condition_id` FROM `product` WHERE `id` ='" . $product_data["id"] . "');");
                                                                                                                $condition_data = $condition_rs->fetch_assoc();
                                                                                                                echo ($condition_data["name"]);
                                                                                                                ?></span>
                                                        <br>
                                                        ...
                                                        <input type="number" onchange='addToCart(<?php echo ($product_data["id"]);  ?>);' class="mt-3 border border-2 border-secondary fs-4 fw-bold px-3 cardqtytext" value="10">
                                                        <br><br>
