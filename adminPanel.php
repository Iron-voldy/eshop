                        ...
                        <div class="offset-1 col-10 col-lg-4 my-3 rounded bg-body">
                            <div class="row g-1 ">
                                ...
                                if ($freq_num > 0) {
                                    ...
                                    $user_rs1 = Database::search("SELECT * FROM `users` WHERE `email`='".$product_data["user_email"]."'");
                                ...
                                <div class="col-12 text-center">
                                    <span class="fs-5 fw-bold">Hasindu Theekshana</span><br />
                                    <span class="fs-5 fw-bold">hasindut1@gmail.com</span><br />
                                    <span class="fs-5 fw-bold">0779393662</span>
