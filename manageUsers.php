                ...
                <div class="col-12 mt-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-2 d-none d-lg-block bg-light py-2" onclick="viewMsgModal('<?php echo $selected_data['email']; ?>');">
                            ...
                            ?>
                                <img src="resource/profile_image/new_user.svg" style="height: 40px; margin-left: 80px;" />
                            <?php
                            }
                            ?>
                        </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="overflow-y: scroll; height:400px;">
                                ...
                                $chat_rs = Database::search("SELECT * FROM `chat` WHERE `from` = '" . $selected_data["email"] . "' OR `to`='" . $selected_data["email"] . "' ORDER BY `date_time` ASC ");
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination pagination-lg justify-content-center">
                        ...
                        ?>
                            ...
                            ?>
                                <li class="page-item">
                                    <a class="page-link" onclick="<?php echo "?page=" . ($x) ?>"><?php echo $x; ?></a>
                                </li>
                        <?php
                            }
                        }
