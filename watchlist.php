                    ...
                    <div class="row">
                        <div class="col-12 border border-1 border-primary rounded mb-2">
                            <div class="row">
                                ...
                                <div class="col-11 col-lg-2 border-end border-1 border-dark">
                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="card-body">
                                                                ...
                                                                $clr_rs = Database::search("SELECT * FROM `colour` WHERE `id`='".$product_data["color_id"]."'");
                                                                ...
                                                                <br />
                                                                <span class="fs-5 fw-bold text-black">Hasindu</span>
                                                            </div>
                                                        </div>
